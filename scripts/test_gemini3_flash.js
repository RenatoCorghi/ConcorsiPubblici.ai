...
const MODEL_NAME = "gemini-3-flash-preview"; // Modello richiesto dal cliente
...
async function runTest() {
    console.log(`🧪 Test Modello ${MODEL_NAME} su 15911...`);
    ...
    try {
        ...
        const outPath = `./sentenze_ssuu_vip/TEST_GEMINI_3_FLASH_15911.md`;
