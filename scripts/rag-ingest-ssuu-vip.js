/**
 * INGESTIONE SS.UU. VIP (NOMOFILACHIA)
 * 
 * Carica le Schede VIP delle Sezioni Unite dalla cartella sentenze_ssuu_vip/
 * nel database RAG con tipo 'nomofilachia_ssuu'.
 * 
 * Uso: node scripts/rag-ingest-ssuu-vip.js [--limit N]
 */
