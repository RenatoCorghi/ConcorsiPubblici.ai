...
const BASE_DIR = path.join(process.cwd(), 'schede_commerciale_vip');

async function ingestCommercialeVIP() {
    console.log("🚀 AVVIO INGESTIONE MASSIVA VIP COMMERCIALE (Open Access)");
    ...
    for (const file of files) {
        ...
        try {
            ...
            const docUuid = generateUUID(`comm_vip_${file}`);
            ...
            let materia = 'Diritto Commerciale';
...
ingestCommercialeVIP().catch(console.error);
