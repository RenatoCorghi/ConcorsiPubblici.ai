...
const BASE_DIR = path.join(process.cwd(), 'schede_penale_vip', 'dottrina_oa');

async function ingestPenaleVIP() {
    console.log("🚀 AVVIO INGESTIONE VIP (Penale Dottrina Open Access)");
    ...
    for (const file of files) {
        ...
        try {
            ...
            const docUuid = generateUUID(`penale_oa_${file}`);
            ...
            let materia = 'Diritto Penale';
            let autorita = 'Dottrina Open Access VIP';
...
ingestPenaleVIP().catch(console.error);
