...
const BASE_DIR = path.join(process.cwd(), 'schede_civile_vip', 'dottrina_oa');

async function ingestDottrinaVIP() {
    console.log("🚀 AVVIO INGESTIONE VIP (Dottrina Open Access)");
    ...
    for (const file of files) {
        ...
        try {
            ...
            const docUuid = generateUUID(`dottrina_oa_${file}`);
            ...
            let materia = 'Diritto Civile (Dottrina)';
            let autorita = 'Dottrina Open Access';
...
ingestDottrinaVIP().catch(console.error);
