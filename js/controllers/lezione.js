            ...
            if (!isWaitMsg) {
                ...
                <div class="mt-4 pt-3 border-t border-gray-700/30">
                    <button onclick="window.Lezione?.openLectureAtModule('${msg.id}')" 
                        ...
                        <span>🎧 Avvia modalità lettura e presentazione</span>
                    </button>
                </div>`;
            }
            container.innerHTML += `
